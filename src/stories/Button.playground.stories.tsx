...
const mockButton = (args: IButtonProps) => {
    ...
    return (
        <>
            <Button {...args} className="space-y-2">Button CTA</Button>

            <Button {...args} LeadingIcon={<FiStar />}>Button CTA</Button>

            <Button {...args} TrailingIcon={<FiArrowRight />}>Button CTA </Button>
...
const sizeValues: IButtonProps["size"][] = ["sm", "md", "lg", "xl", "2xl", undefined];

const variantValues: IButtonProps["variant"][] = ["primary", "secondary", "secondaryGray", "tertiary", "tertiaryGray"];
...
const meta: Meta<typeof Button> = {
    ...
    argTypes: {
        ...
        size: {
            control: "radio",
            mapping: sizeValues.map((size) => { size; }),
            options: sizeValues
        },
        TrailingIcon: {
            table: { disable: true }
        ...
        variant: {
            control: "radio",
            mapping: variantValues.map((variant) => { variant; }),
